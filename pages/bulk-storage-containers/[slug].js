...
export async function getStaticPaths() {
  let condition = {"domain":{"name": DOMAIN}, "product_identify_cat": menu.palletBox.product_identify_cat}
...
export async function getStaticProps({ params }) {
  ...
  let condition = {"domain":{"name": DOMAIN}, "product_identify_cat": menu.palletBox.product_identify_cat, "slug": params.slug}
