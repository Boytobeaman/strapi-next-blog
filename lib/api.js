...
export async function graphqlFetchAPI(query, { variables } = {}, url) {
...
export async function getWebsiteProductsByCategory(cat) {
  return axios.get(`${platform_root}/website-products/?website_product_category=${cat}`)
}

export async function getWebsiteProduct(cat, slug) {
  return axios.get(`${platform_root}/website-products/?website_product_category=${cat}&slug=${slug}`)
}


export async function getProductAttributesByCategory(cat) {
  return axios.get(`${platform_root}${attributes_path}/?product_category=${cat}`)
}

export async function getProductsByCategory(cat) {
  return axios.get(`${platform_root}${products_path}/?product_category=${cat}`)
}